...
################################################
# 	
#	This perl script is adapted from https://github.com/valflanza/ResCap
#	Lanza, V.F., et al. (2018). In-depth resistome analysis by targeted metagenomics. Microbiome, 6(1). 
#		https://doi.org/10.1186/s40168-017-0387-y
#
#	procSam.pl performs the counting of reads per gene, reads per kilobase per gene,
